...
description: A practical framework for setting return expectations that are useful for planning instead of optimized for optimism.
...
| Planning question | Better framing |
| --- | --- |
